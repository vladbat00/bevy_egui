...
- Schedule egui 3d render pass after `PostProcess` to prevent tonemapping race ([#491](https://github.com/vladbat00/bevy_egui/pull/491) by @g4borg).

## [0.41.0] - 30-Jun-2026

### Changed

- Update to egui 0.35 ([#488](https://github.com/vladbat00/bevy_egui/pull/488) by @hacknus).
